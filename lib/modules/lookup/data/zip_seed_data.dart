...
/// Small fallback seed dataset used only if the bundled
/// `assets/data/lookup_data.json` fails to load (e.g. isolated widget
/// tests). The full merged dataset lives in that asset.
